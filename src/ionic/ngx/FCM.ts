...
export class FCM {
    ...
    public static plugin: string = 'cordova-plugin-fcm-with-dependecy-updated-fix-cordova-android-11'
    public static pluginRef: string = 'FCM'
    public static repo: string =
        'https://github.com/kolodziejm355/cordova-plugin-fcm-with-dependecy-updated-fix-cordova-android-11'
