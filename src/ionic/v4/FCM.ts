...
@Plugin({
    pluginName: 'FCM',
    plugin: 'cordova-plugin-fcm-with-dependecy-updated-fix-cordova-android-11',
    pluginRef: 'FCM',
    repo: 'https://github.com/kolodziejm355/cordova-plugin-fcm-with-dependecy-updated-fix-cordova-android-11',
